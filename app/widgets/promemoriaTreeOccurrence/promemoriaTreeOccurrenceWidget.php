<?php
/* ----------------------------------------------------------------------
 * promemoriaTreeOccurrenceWidget.php :
...
class promemoriaTreeOccurrenceWidget extends BaseWidget implements IWidget {
	# -------------------------------------------------------
	...
	public function __construct( $ps_widget_path, $pa_settings ) {
		$this->title       = _t( 'Tree Occurrences' );
		$this->description = _t( 'Displays objects in a hierarchical structure' );
		parent::__construct( $ps_widget_path, $pa_settings );

		$this->opo_config = Configuration::load( $ps_widget_path . '/conf/promemoriaTreeOccurrenceWidget.conf' );
	}
	# -------------------------------------------------------
...
BaseWidget::$s_widget_settings['promemoriaTreeOccurrenceWidget'] = array();
?>
