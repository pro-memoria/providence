<?php
/* ----------------------------------------------------------------------
 * promemoriaTreeEntityWidget.php :
...
class promemoriaTreeEntityWidget extends BaseWidget implements IWidget {
	# -------------------------------------------------------
	...
	public function __construct( $ps_widget_path, $pa_settings ) {
		$this->title       = _t( 'Tree Entities' );
		$this->description = _t( 'Displays objects in a hierarchical structure' );
		parent::__construct( $ps_widget_path, $pa_settings );

		$this->opo_config = Configuration::load( $ps_widget_path . '/conf/promemoriaTreeEntityWidget.conf' );
	}
	# -------------------------------------------------------
...
BaseWidget::$s_widget_settings['promemoriaTreeEntityWidget'] = array();
?>
